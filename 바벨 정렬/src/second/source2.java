...
class Cycle2  {
	...
	public long findCycleWithStartIndex(int s , int Bn, List<Integer> things) {
...
public class source2 {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 0 ; i < n; i++)  {
			c.addNode(new Node1(i+1,   sorted.indexOf(things.get(i))  + 1   )  );
		}

		do {
			long w = c.findCycleWithStartIndex(startCycleCheck++, Bn, things);
			weightTotal+=w;
